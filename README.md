...
2. Склонировать и построить [лекционный проект](https://github.com/netology-code/mqa-homeworks/tree/mqa-video/2.1%20auto/lesson_sample_app). 
...
Этапы выполнения:
1. Клонировать и построить [проект для домашнего задания](https://github.com/netology-code/mqa-homeworks/tree/mqa-video/2.1%20auto/hw_app). 
...
В качестве отчёта о выполнении домашней работы нужно отправить ссылку на свой Git-репозиторий, в который необходимо загрузить [проект домашнего задания](https://github.com/netology-code/mqa-homeworks/tree/mqa-video/2.1%20auto/hw_app) c добавленным автоматическим тестом.
